...
Before adding a tool, skill, plugin, package, MCP server, third-party service, or custom implementation, RealmOS should consider whether an existing capability is better.
